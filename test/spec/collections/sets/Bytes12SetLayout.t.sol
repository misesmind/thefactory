...
/**
 * @title Bytes12SetLayoutTest Unit tests for storage layout operations upon an Bytes12Set struct.
 * @author mises mind <misesmind@proton.me>
 */
contract Bytes12SetLayoutTest is BetterTest {

    using Bytes12SetLayout for Bytes12Set;

    Bytes12Set testInstance;
